# Branchenspezifisch manufacturing automation simple webhook processor (basic)
...
**Template-Name:** `branchenspezifisch_basic_v1_HS458.SOSTZ_manufacturing-automation_simple-webhook-processor`  
...
`branchenspezifisch`, `manufacturing-automation`, `simple-webhook-processor`, `basic`, `professional`, `steindl-templates`, `version-290`, `nodes-5`

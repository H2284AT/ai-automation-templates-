...
**Template-Name:** `branchenspezifisch_intermediate_v1_HS993.ZMQEW_quality-control_dynamic-workflow-orchestrator`  
...
`branchenspezifisch`, `quality-control`, `dynamic-workflow-orchestrator`, `intermediate`, `professional`, `steindl-templates`, `version-292`, `nodes-7`

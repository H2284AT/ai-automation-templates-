# Geschaeftsprozesse budget tracking basic data collector (basic)
...
**Template-Name:** `geschaeftsprozesse_basic_v1_HS420.ZYZDL_budget-tracking_basic-data-collector`  
...
`geschaeftsprozesse`, `budget-tracking`, `basic-data-collector`, `basic`, `professional`, `steindl-templates`, `version-268`, `nodes-3`

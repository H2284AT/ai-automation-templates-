# Geschaeftsprozesse pipeline management streamlined integration (basic)
...
**Template-Name:** `geschaeftsprozesse_basic_v1_HS002.NRTXR_pipeline-management_streamlined-integration`  
...
`geschaeftsprozesse`, `pipeline-management`, `streamlined-integration`, `basic`, `professional`, `steindl-templates`, `version-299`, `nodes-4`

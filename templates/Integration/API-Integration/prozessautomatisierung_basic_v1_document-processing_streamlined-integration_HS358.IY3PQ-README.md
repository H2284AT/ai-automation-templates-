...
**Template-Name:** `prozessautomatisierung_basic_v1_HS358.IY3PQ_document-processing_streamlined-integration`  
...
`prozessautomatisierung`, `document-processing`, `streamlined-integration`, `basic`, `professional`, `steindl-templates`, `version-272`, `nodes-4`

# Prozessautomatisierung report generation streamlined integration (basic)
...
**Template-Name:** `prozessautomatisierung_basic_v1_HS303.WK4IV_report-generation_streamlined-integration`  
...
`prozessautomatisierung`, `report-generation`, `streamlined-integration`, `basic`, `professional`, `steindl-templates`, `version-299`, `nodes-3`

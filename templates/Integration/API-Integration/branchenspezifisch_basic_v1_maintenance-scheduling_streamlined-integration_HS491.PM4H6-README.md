# Branchenspezifisch maintenance scheduling streamlined integration (basic)
...
**Template-Name:** `branchenspezifisch_basic_v1_HS491.PM4H6_maintenance-scheduling_streamlined-integration`  
...
`branchenspezifisch`, `maintenance-scheduling`, `streamlined-integration`, `basic`, `professional`, `steindl-templates`, `version-302`, `nodes-3`

---

*Professional Template by Herbert Steindl • Version 302 • Portfolio Analysis: 0 templates reviewed*  
*Specialization: maintenance-scheduling • Concept: streamlined-integration*
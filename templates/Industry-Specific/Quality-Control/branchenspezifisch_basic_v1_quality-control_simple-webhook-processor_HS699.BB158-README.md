...
**Template-Name:** `branchenspezifisch_basic_v1_HS699.BB158_quality-control_simple-webhook-processor`  
...
`branchenspezifisch`, `quality-control`, `simple-webhook-processor`, `basic`, `professional`, `steindl-templates`, `version-272`, `nodes-3`

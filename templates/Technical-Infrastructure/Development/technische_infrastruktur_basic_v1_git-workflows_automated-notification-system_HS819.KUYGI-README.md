# Technische-Infrastruktur git workflows automated notification system (basic)
...
**Template-Name:** `technische_infrastruktur_basic_v1_HS819.KUYGI_git-workflows_automated-notification-system`  
...
`technische-infrastruktur`, `git-workflows`, `automated-notification-system`, `basic`, `professional`, `steindl-templates`, `version-292`, `nodes-5`

...
**Template-Name:** `technische_infrastruktur_basic_v1_HS554.ODWQN_deployment-management_quick-response-handler`  
...
`technische-infrastruktur`, `deployment-management`, `quick-response-handler`, `basic`, `professional`, `steindl-templates`, `version-276`, `nodes-4`

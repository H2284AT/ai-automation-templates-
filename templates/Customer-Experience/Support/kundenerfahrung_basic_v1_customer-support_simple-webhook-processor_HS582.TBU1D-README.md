...
**Template-Name:** `kundenerfahrung_basic_v1_HS582.TBU1D_customer-support_simple-webhook-processor`  
...
`kundenerfahrung`, `customer-support`, `simple-webhook-processor`, `basic`, `professional`, `steindl-templates`, `version-278`, `nodes-4`

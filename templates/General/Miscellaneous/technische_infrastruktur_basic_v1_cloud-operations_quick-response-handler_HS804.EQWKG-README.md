# Technische-Infrastruktur cloud operations quick response handler (basic)
...
**Template-Name:** `technische_infrastruktur_basic_v1_HS804.EQWKG_cloud-operations_quick-response-handler`  
...
`technische-infrastruktur`, `cloud-operations`, `quick-response-handler`, `basic`, `professional`, `steindl-templates`, `version-266`, `nodes-5`

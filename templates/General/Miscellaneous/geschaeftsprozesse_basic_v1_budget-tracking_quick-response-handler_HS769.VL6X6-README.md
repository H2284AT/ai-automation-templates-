...
**Template-Name:** `geschaeftsprozesse_basic_v1_HS769.VL6X6_budget-tracking_quick-response-handler`  
...
`geschaeftsprozesse`, `budget-tracking`, `quick-response-handler`, `basic`, `professional`, `steindl-templates`, `version-295`, `nodes-3`
